...
PROTOBUF_NAMESPACE_OPEN
template<> ::jhrpc::RpcHeader* Arena::CreateMaybeMessage<::jhrpc::RpcHeader>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace jhrpc {
...
class RpcHeader final :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:jhrpc.RpcHeader) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:jhrpc.RpcHeader)
 private:
  class _Internal;
...
inline const std::string& RpcHeader::service_name() const {
  // @@protoc_insertion_point(field_get:jhrpc.RpcHeader.service_name)
...
void RpcHeader::set_service_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.service_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:jhrpc.RpcHeader.service_name)
}
inline std::string* RpcHeader::mutable_service_name() {
  std::string* _s = _internal_mutable_service_name();
  // @@protoc_insertion_point(field_mutable:jhrpc.RpcHeader.service_name)
  return _s;
}
...
inline std::string* RpcHeader::release_service_name() {
  // @@protoc_insertion_point(field_release:jhrpc.RpcHeader.service_name)
...
inline void RpcHeader::set_allocated_service_name(std::string* service_name) {
  ...
  // @@protoc_insertion_point(field_set_allocated:jhrpc.RpcHeader.service_name)
}
...
inline const std::string& RpcHeader::method_name() const {
  // @@protoc_insertion_point(field_get:jhrpc.RpcHeader.method_name)
...
void RpcHeader::set_method_name(ArgT0&& arg0, ArgT... args) {
 ...
 _impl_.method_name_.SetBytes(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:jhrpc.RpcHeader.method_name)
}
inline std::string* RpcHeader::mutable_method_name() {
  std::string* _s = _internal_mutable_method_name();
  // @@protoc_insertion_point(field_mutable:jhrpc.RpcHeader.method_name)
  return _s;
}
...
inline std::string* RpcHeader::release_method_name() {
  // @@protoc_insertion_point(field_release:jhrpc.RpcHeader.method_name)
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:jhrpc.RpcHeader.method_name)
}
...
inline uint32_t RpcHeader::args_len() const {
  // @@protoc_insertion_point(field_get:jhrpc.RpcHeader.args_len)
...
inline void RpcHeader::set_args_len(uint32_t value) {
  ...
  // @@protoc_insertion_point(field_set:jhrpc.RpcHeader.args_len)
}
